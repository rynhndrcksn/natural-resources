        ...
        <div class="col-12 col-lg-6 col-md-8 col-sm-10 mx-auto p-0 mt-5 mb-5 rounded-lg" id="starterForm">
            <form class="w-75 mx-auto pt-5 pb-5 text-white" method="post" action="#">
                ...
                <div class="text-center pt-3">
                    <p>
                        <a class="" href="<?php echo base_url('/register') ?>">Create Account</a> |
                        <a class="" href="<?php echo base_url('/reset') ?>">Recover Password</a>
                    </p>
                    <p>Not a Green River College student?
                        <a class="" href="https://www.greenriver.edu/students/online-services/"><br>Get Started Here</a>
                    </p>
                </div>
            </form>
        </div>
